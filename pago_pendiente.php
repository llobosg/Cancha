...
<head>
  ...
  <title>Pago Pendiente | CanchaSport</title>
  ...
  <style>
    ...
    .pending { color: #ffc107; font-size: 3rem; margin-bottom: 1rem; }
    h1 { color: #071289; }
...
<body>
  <div class="container">
    ...
    <p>Tu pago está siendo procesado. Recibirás una confirmación por correo.</p>
