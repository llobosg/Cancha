    ...
    <form id="registroForm" enctype="multipart/form-data">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <?php if ($modo_individual || $modo_torneo): ?>
            <input type="text" id="rol" value="Jugador" style="padding:0.6rem;border:1px solid #ccc;border-radius:5px;background:#fafcff;color:#071289;width:100%;">
          <?php else: ?>
        ...
        if (data.success) {
          ...
          <?php else: ?>
            if (data.club_slug && data.club_slug.trim() !== '') {
              window.location.href = 'verificar_codigo_socio.php?club=' + encodeURIComponent(data.club_slug);
            } else {
              window.location.href = 'verificar_codigo_socio.php?id_socio=' + encodeURIComponent(data.id_socio);
            }
          <?php endif; ?>
        } else {
          alert('❌ ' + data.message);
