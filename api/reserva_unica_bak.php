...
try {
    ...
    // === INSERTAR RESERVA (VERSIÓN BLINDADA) ===
    // Si id_club da error, podemos quitarlo temporalmente de este query específico
    // Pero primero intentemos con él.
    
    $sql = "INSERT INTO reservas (id_cancha, id_club, id_socio, nombre_cliente, email_cliente, telefono_cliente, fecha, hora_inicio, hora_fin, monto_total, jugadores_esperados, estado_pago, estado) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 4, 'pendiente', 'confirmada')";
